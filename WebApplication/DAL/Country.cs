		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[EnDescription] = _Country.PropertyNames.EnDescription;
					ht[ArDescription] = _Country.PropertyNames.ArDescription;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[EnDescription] = _Country.ColumnNames.EnDescription;
					ht[ArDescription] = _Country.ColumnNames.ArDescription;
