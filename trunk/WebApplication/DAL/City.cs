		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[EnName] = _City.PropertyNames.EnName;
					ht[ArName] = _City.PropertyNames.ArName;
					ht[EnDescription] = _City.PropertyNames.EnDescription;
					ht[ArDescription] = _City.PropertyNames.ArDescription;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[EnName] = _City.ColumnNames.EnName;
					ht[ArName] = _City.ColumnNames.ArName;
					ht[EnDescription] = _City.ColumnNames.EnDescription;
					ht[ArDescription] = _City.ColumnNames.ArDescription;
