...
{
	public abstract class _Course_Data_DataType : SqlClientEntity
	{
		public _Course_Data_DataType()
		{
			this.QuerySource = "Course_Data_DataType";
			this.MappingName = "Course_Data_DataType";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Course_Data_DataTypeLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int DataTypeID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.DataTypeID, DataTypeID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_Course_Data_DataTypeLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[DataTypeID] = _Course_Data_DataType.PropertyNames.DataTypeID;
					ht[Name] = _Course_Data_DataType.PropertyNames.Name;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[DataTypeID] = _Course_Data_DataType.ColumnNames.DataTypeID;
					ht[Name] = _Course_Data_DataType.ColumnNames.Name;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Course_Data_DataTypeInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.DataTypeID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Course_Data_DataTypeUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_Course_Data_DataTypeDelete]";
