...
namespace Corsat.DAL
{
	public abstract class _Course : SqlClientEntity
	{
		...
		protected class Parameters
		{
			...
			public static SqlParameter CourseLevel
			{
				get
				{
					return new SqlParameter("@CourseLevel", SqlDbType.Int, 0);
				}
			}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[CourseLevel] = _Course.PropertyNames.CourseLevel;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[CourseLevel] = _Course.ColumnNames.CourseLevel;
		...
		{  
            ...
            public const string CourseLevel = "s_CourseLevel";
		...
		public virtual int CourseLevel
	    {
			get
	        {
				return base.Getint(ColumnNames.CourseLevel);
			}
			set
	        {
				base.Setint(ColumnNames.CourseLevel, value);
			}
		}
		...
		public virtual string s_CourseLevel
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.CourseLevel) ? string.Empty : base.GetintAsString(ColumnNames.CourseLevel);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.CourseLevel);
				else
					this.CourseLevel = base.SetintAsString(ColumnNames.CourseLevel, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter CourseLevel
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.CourseLevel, Parameters.CourseLevel);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter CourseLevel
		    {
				get
		        {
					if(_CourseLevel_W == null)
	        	    {
						_CourseLevel_W = TearOff.CourseLevel;
					}
					return _CourseLevel_W;
				}
			}
			...
			private WhereParameter _CourseLevel_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter CourseLevel
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.CourseLevel, Parameters.CourseLevel);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _CourseLevel_W = null;
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.CourseLevel);
			p.SourceColumn = ColumnNames.CourseLevel;
			p.SourceVersion = DataRowVersion.Current;
